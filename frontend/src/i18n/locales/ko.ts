export default {
  ...
  printers: {
    ...
    plateDetection: {
      ...
      decision: {
        title: '판정 내역',
        backendOpencv: 'OpenCV 기준 이미지 비교',
        backendAi: 'AI 비전 모델',
        verdict: '판정',
        reason: '모델의 판단 근거',
        aiConfigHint: '아래의 저장된 기준 이미지와 감지 영역은 OpenCV 백엔드에만 적용됩니다. AI 백엔드는 카메라 프레임 전체를 평가합니다.',
        modeLabel: '이 프린터의 백엔드',
        modeGlobal: '전역 기본값',
        modeSaved: '프린터 감지 백엔드가 업데이트되었습니다',
      },
      confidence: '신뢰도',
      difference: '차이',
  ...
  settings: {
    ...
    ambientDryingSustainedEnabled: '지속적인 습도 요구',
    ambientDryingSustainedDescription: '환경 건조를 시작하기 전에 습도가 설정된 시간 동안 임계값을 초과한 상태를 유지할 때까지 대기합니다 — AMS 덮개를 열 때 발생하는 급증을 걸러냅니다.',
    ambientDryingSustainedMinutes: '지속 시간 (분)',
  ...
  bedcheckAi: {
    title: '빌드 플레이트 확인 — AI 백엔드',
    description: '인쇄를 시작하기 전에 Bambuddy가 빌드 플레이트가 비어 있는지 판단하는 방식을 선택하세요: 내장된 OpenCV 비교 또는 AI 비전 모델.',
    backendLabel: '감지 백엔드',
    backendOpencv: 'OpenCV (기본값)',
    backendAi: 'AI',
    ...
    apiKeyHint: '필요하지 않은 로컬 서버라면 비워 두세요.',
    apiKeyPlaceholder: '엔드포인트에 키가 필요하지 않으면 비워 두세요',
    testButton: '연결 테스트',
    ...
    useGlobal: '전역 기본값 ({{backend}})',
    noPrinters: '구성된 프린터가 없습니다.',
    printerUpdated: '프린터 감지 백엔드가 업데이트되었습니다',
    statusTitle: '상태',
    globalBackend: '전역 백엔드',
    notMonitored: '모니터링 안 함',
  },
  makerworld: {
    title: 'MakerWorld',
