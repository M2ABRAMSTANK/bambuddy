export default {
  ...
  printers: {
    ...
    plateDetection: {
      ...
      decision: {
        title: '判定详情',
        backendOpencv: 'OpenCV 参考图对比',
        backendAi: 'AI 视觉模型',
        verdict: '判定结果',
        reason: '模型判断依据',
        aiConfigHint: '下方保存的参考图和检测区域仅适用于 OpenCV 后端 — AI 后端会评估整个相机画面。',
        modeLabel: '此打印机的后端',
        modeGlobal: '全局默认',
        modeSaved: '打印机检测后端已更新',
      },
      confidence: '置信度',
      difference: '差异',
  ...
  settings: {
    ...
    ambientDryingSustainedEnabled: '需要持续湿度',
    ambientDryingSustainedDescription: '开始环境干燥前，等待湿度持续高于阈值达到设定时长——以缓冲打开AMS盖子造成的湿度骤升。',
    ambientDryingSustainedMinutes: '持续时长（分钟）',
  ...
  bedcheckAi: {
    title: '打印板检查 — AI 后端',
    description: '选择 Bambuddy 在开始打印前如何判断打印板是否为空:内置的 OpenCV 比对,或 AI 视觉模型。',
    backendLabel: '检测后端',
    backendOpencv: 'OpenCV(默认)',
    backendAi: 'AI',
    ...
    apiKeyHint: '如果您的本地服务器不需要密钥,请留空。',
    apiKeyPlaceholder: '如果端点不需要密钥,请留空',
    testButton: '测试连接',
    ...
    useGlobal: '全局默认（{{backend}}）',
    noPrinters: '未配置打印机。',
    printerUpdated: '打印机检测后端已更新',
    statusTitle: '状态',
    globalBackend: '全局后端',
    notMonitored: '未监控',
  },
