export default {
  ...
  printers: {
    ...
    plateDetection: {
      ...
      decision: {
        title: 'Karar',
        backendOpencv: 'OpenCV referans karşılaştırması',
        backendAi: 'Yapay zekâ görü modeli',
        verdict: 'Sonuç',
        reason: 'Modelin gerekçesi',
        aiConfigHint: 'Aşağıdaki kayıtlı referanslar ve algılama alanı yalnızca OpenCV arka ucu için geçerlidir — yapay zekâ arka ucu tüm kamera karesini değerlendirir.',
  ...
  settings: {
    ...
    tabs: {
      ...
      buildPlateCheck: 'Baskı Tablası Kontrolü',
    ...
    ambientDryingSustainedEnabled: 'Sürekli nem gerektir',
    ambientDryingSustainedDescription: 'Ortam kurutmasını başlatmadan önce nemin belirlenen bir süre boyunca eşiğin üzerinde kalmasını bekle — AMS kapağının açılmasından kaynaklanan ani yükselişi atlatır.',
    ambientDryingSustainedMinutes: 'Sürekli süre (dakika)',
  ...
  bedcheckAi: {
    ...
    useGlobal: 'Genel varsayılan ({{backend}})',
    noPrinters: 'Yapılandırılmış yazıcı yok.',
    printerUpdated: 'Yazıcının algılama arka ucu güncellendi',
    statusTitle: 'Durum',
