export default {
  ...
  printers: {
    ...
    plateDetection: {
      ...
      decision: {
        title: 'Decisione',
        backendOpencv: 'Confronto di riferimento OpenCV',
        backendAi: 'Modello di visione IA',
        verdict: 'Verdetto',
        reason: 'Ragionamento del modello',
        aiConfigHint: 'I riferimenti salvati e l\'area di rilevamento qui sotto si applicano solo al backend OpenCV — il backend IA valuta l\'intero fotogramma della camera.',
        modeLabel: 'Backend per questa stampante',
        modeGlobal: 'Predefinito globale',
        modeSaved: 'Backend di rilevamento della stampante aggiornato',
      },
  ...
  settings: {
    ...
    tabs: {
      ...
      buildPlateCheck: 'Controllo del piatto',
      users: 'Utenti',
      backup: 'Backup',
    ...
    ambientDryingSustainedEnabled: 'Richiedi umidità sostenuta',
    ambientDryingSustainedDescription: 'Attendere che l\'umidità sia rimasta sopra la soglia per un periodo di tempo impostato prima di avviare un\'asciugatura ambientale — assorbe il picco causato dall\'apertura del coperchio dell\'AMS.',
    ambientDryingSustainedMinutes: 'Tempo sostenuto (minuti)',
  ...
  bedcheckAi: {
    title: 'Controllo piatto — backend IA',
    description: 'Scegli come Bambuddy decide se il piatto è vuoto prima dell\'avvio di una stampa: il confronto OpenCV integrato o un modello di visione IA.',
    backendLabel: 'Backend di rilevamento',
    backendOpencv: 'OpenCV (predefinito)',
    backendAi: 'IA',
    ...
    apiKeyHint: 'Lascia vuoto se il tuo server locale non ne richiede una.',
    apiKeyPlaceholder: 'Lascia vuoto se l\'endpoint non richiede una chiave',
    ...
    useGlobal: 'Predefinito globale ({{backend}})',
    noPrinters: 'Nessuna stampante configurata.',
    printerUpdated: 'Backend di rilevamento della stampante aggiornato',
    statusTitle: 'Stato',
    globalBackend: 'Backend globale',
    notMonitored: 'Non monitorata',
  },
  makerworld: {
    title: 'MakerWorld',
