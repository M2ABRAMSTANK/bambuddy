export default {
  ...
  printers: {
    ...
    plateDetection: {
      ...
      decision: {
        title: 'Decision',
        backendOpencv: 'OpenCV reference comparison',
        backendAi: 'AI vision model',
        verdict: 'Verdict',
        reason: 'Model reasoning',
        aiConfigHint: 'Saved references and the detection area below apply to the OpenCV backend only — the AI backend evaluates the full camera frame.',
  ...
  settings: {
    ...
    tabs: {
      ...
      buildPlateCheck: 'Build Plate Check',
    ...
    ambientDryingSustainedEnabled: 'Require sustained humidity',
    ambientDryingSustainedDescription: 'Wait until humidity has stayed above the threshold for a set time before starting an ambient dry — rides out the spike from opening the AMS lid.',
    ambientDryingSustainedMinutes: 'Sustained time (minutes)',
  ...
  bedcheckAi: {
    ...
    useGlobal: 'Global default ({{backend}})',
    noPrinters: 'No printers configured.',
    printerUpdated: 'Printer detection backend updated',
    statusTitle: 'Status',
