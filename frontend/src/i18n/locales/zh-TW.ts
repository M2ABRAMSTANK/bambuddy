export default {
  ...
  printers: {
    ...
    plateDetection: {
      ...
      decision: {
        title: '判定詳情',
        backendOpencv: 'OpenCV 參考圖比對',
        backendAi: 'AI 視覺模型',
        verdict: '判定結果',
        reason: '模型判斷依據',
        aiConfigHint: '下方儲存的參考圖與偵測區域僅適用於 OpenCV 後端 — AI 後端會評估整個相機畫面。',
        modeLabel: '此印表機的後端',
        modeGlobal: '全域預設',
        modeSaved: '印表機偵測後端已更新',
      },
      confidence: '置信度',
      difference: '差異',
  ...
  settings: {
    ...
    ambientDryingSustainedEnabled: '需要持續濕度',
    ambientDryingSustainedDescription: '在開始環境乾燥前，等待濕度持續高於閾值達到設定時長——以緩衝開啟AMS蓋子造成的濕度驟升。',
    ambientDryingSustainedMinutes: '持續時長（分鐘）',
  ...
  bedcheckAi: {
    title: '列印板檢查 — AI 後端',
    description: '選擇 Bambuddy 在開始列印前如何判斷列印板是否為空:內建的 OpenCV 比對,或 AI 視覺模型。',
    backendLabel: '檢測後端',
    backendOpencv: 'OpenCV(預設)',
    backendAi: 'AI',
    ...
    apiKeyHint: '如果您的本機伺服器不需要金鑰,請留空。',
    apiKeyPlaceholder: '如果端點不需要金鑰,請留空',
    testButton: '測試連線',
    ...
    useGlobal: '全域預設（{{backend}}）',
    noPrinters: '未設定印表機。',
    printerUpdated: '印表機偵測後端已更新',
    statusTitle: '狀態',
    globalBackend: '全域後端',
    notMonitored: '未監控',
  },
