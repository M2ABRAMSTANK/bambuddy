export default {
  ...
  printers: {
    ...
    plateDetection: {
      ...
      decision: {
        title: 'Décision',
        backendOpencv: 'Comparaison de référence OpenCV',
        backendAi: 'Modèle de vision IA',
        verdict: 'Résultat',
        reason: 'Raisonnement du modèle',
        aiConfigHint: 'Les références enregistrées et la zone de détection ci-dessous ne s\'appliquent qu\'au backend OpenCV — le backend IA analyse l\'image caméra complète.',
        modeLabel: 'Backend pour cette imprimante',
        modeGlobal: 'Valeur globale par défaut',
        modeSaved: 'Backend de détection de l\'imprimante mis à jour',
      },
  ...
  settings: {
    ...
    tabs: {
      ...
      buildPlateCheck: 'Vérification du plateau',
    ...
    ambientDryingSustainedEnabled: 'Exiger une humidité soutenue',
    ambientDryingSustainedDescription: 'Attendre que l\'humidité soit restée au-dessus du seuil pendant une durée définie avant de démarrer un séchage ambiant — absorbe le pic dû à l\'ouverture du couvercle de l\'AMS.',
    ambientDryingSustainedMinutes: 'Durée soutenue (minutes)',
  ...
  bedcheckAi: {
    title: 'Vérification du plateau — backend IA',
    description: 'Choisissez comment Bambuddy détermine si le plateau est vide avant le début d\'une impression : la comparaison OpenCV intégrée, ou un modèle de vision par IA.',
    backendLabel: 'Backend de détection',
    backendOpencv: 'OpenCV (par défaut)',
    backendAi: 'IA',
    ...
    apiKeyHint: 'Laissez vide si votre serveur local n\'en nécessite pas.',
    apiKeyPlaceholder: 'Laissez vide si l\'endpoint ne requiert pas de clé',
    ...
    useGlobal: 'Valeur globale ({{backend}})',
    noPrinters: 'Aucune imprimante configurée.',
    printerUpdated: 'Backend de détection de l\'imprimante mis à jour',
    statusTitle: 'État',
    globalBackend: 'Backend global',
    notMonitored: 'Non surveillée',
  },
  makerworld: {
    title: 'MakerWorld',
