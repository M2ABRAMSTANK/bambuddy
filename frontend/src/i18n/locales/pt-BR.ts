export default {
  ...
  printers: {
    ...
    drying: {
      ...
      timeRemaining: '{{time}} restante',
      active: 'Secagem',
      notStarted: 'Secagem não iniciada',
      notStartedHint: 'A impressora aceitou o comando de secagem, mas o AMS não iniciou o ciclo — pode estar aguardando energia ou a impressão em andamento.',
    ...
    plateDetection: {
      ...
      decision: {
        title: 'Decisão',
        backendOpencv: 'Comparação de referência OpenCV',
        backendAi: 'Modelo de visão IA',
        verdict: 'Veredito',
        reason: 'Raciocínio do modelo',
        aiConfigHint: 'As referências salvas e a área de detecção abaixo aplicam-se apenas ao backend OpenCV — o backend de IA avalia o quadro completo da câmera.',
        modeLabel: 'Backend para esta impressora',
        modeGlobal: 'Padrão global',
        modeSaved: 'Backend de detecção da impressora atualizado',
      },
  ...
  settings: {
    ...
    tabs: {
      ...
      buildPlateCheck: 'Verificação da mesa',
      users: 'Autenticação',
      backup: 'Backup',
    ...
    ambientDryingSustainedEnabled: 'Exigir umidade sustentada',
    ambientDryingSustainedDescription: 'Aguardar até que a umidade permaneça acima do limite por um tempo definido antes de iniciar uma secagem ambiente — absorve o pico causado ao abrir a tampa do AMS.',
    ambientDryingSustainedMinutes: 'Tempo sustentado (minutos)',
  ...
  bedcheckAi: {
    title: 'Verificação da Placa — Backend de IA',
    description: 'Escolha como o Bambuddy decide se a placa de construção está vazia antes de iniciar uma impressão: a comparação OpenCV integrada, ou um modelo de visão por IA.',
    backendLabel: 'Backend de detecção',
    backendOpencv: 'OpenCV (padrão)',
    backendAi: 'IA',
    ...
    apiKeyHint: 'Deixe vazio se o seu servidor local não exigir uma.',
    apiKeyPlaceholder: 'Deixe vazio se o endpoint não exigir chave',
    ...
    useGlobal: 'Padrão global ({{backend}})',
    noPrinters: 'Nenhuma impressora configurada.',
    printerUpdated: 'Backend de detecção da impressora atualizado',
    statusTitle: 'Status',
    globalBackend: 'Backend global',
    notMonitored: 'Não monitorada',
  },
  makerworld: {
    title: 'MakerWorld',
