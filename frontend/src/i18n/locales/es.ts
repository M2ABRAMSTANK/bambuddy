export default {
  ...
  printers: {
    ...
    plateDetection: {
      ...
      decision: {
        title: 'Decisión',
        backendOpencv: 'Comparación de referencia OpenCV',
        backendAi: 'Modelo de visión IA',
        verdict: 'Veredicto',
        reason: 'Razonamiento del modelo',
        aiConfigHint: 'Las referencias guardadas y el área de detección de abajo solo se aplican al backend OpenCV — el backend de IA evalúa toda la imagen de la cámara.',
  ...
  settings: {
    ...
    tabs: {
      ...
      buildPlateCheck: 'Comprobación de la placa',
      users: 'Autenticación',
    ...
    ambientDryingSustainedEnabled: 'Requerir humedad sostenida',
    ambientDryingSustainedDescription: 'Esperar hasta que la humedad se haya mantenido por encima del umbral durante un tiempo definido antes de iniciar un secado ambiental — absorbe el pico al abrir la tapa del AMS.',
    ambientDryingSustainedMinutes: 'Tiempo sostenido (minutos)',
  ...
  bedcheckAi: {
    ...
    useGlobal: 'Predeterminado global ({{backend}})',
    noPrinters: 'No hay impresoras configuradas.',
    printerUpdated: 'Backend de detección de la impresora actualizado',
    statusTitle: 'Estado',
