export default {
  ...
  printers: {
    ...
    plateDetection: {
      ...
      decision: {
        title: 'Entscheidung',
        backendOpencv: 'OpenCV-Referenzvergleich',
        backendAi: 'KI-Bildmodell',
        verdict: 'Ergebnis',
        reason: 'Begründung des Modells',
        aiConfigHint: 'Gespeicherte Referenzen und der Erkennungsbereich unten gelten nur für das OpenCV-Backend — das KI-Backend wertet das gesamte Kamerabild aus.',
  ...
  settings: {
    ...
    tabs: {
      ...
      buildPlateCheck: 'Druckbett-Prüfung',
    ...
    ambientDryingSustainedEnabled: 'Anhaltende Luftfeuchtigkeit erforderlich',
    ambientDryingSustainedDescription: 'Warten, bis die Luftfeuchtigkeit für eine festgelegte Zeit über dem Schwellenwert geblieben ist, bevor eine Umgebungstrocknung startet — überbrückt den Anstieg durch das Öffnen des AMS-Deckels.',
    ambientDryingSustainedMinutes: 'Wartezeit (Minuten)',
  ...
  bedcheckAi: {
    ...
    useGlobal: 'Globaler Standard ({{backend}})',
    noPrinters: 'Keine Drucker konfiguriert.',
    printerUpdated: 'Erkennungs-Backend des Druckers aktualisiert',
    statusTitle: 'Status',
